...
function productDetail(pno){
	document.detailFrm.pno.value=pno;
...
function productDetail_admin(pno){
	document.detailFrm.pno.value=pno;
	document.detailFrm.submit();
}
...
function productUpdate(pno){
	document.updateFrm.pno.value=pno;
	document.updateFrm.submit();
}
function productDelete(pno){
	document.delFrm.pno.value=pno;
