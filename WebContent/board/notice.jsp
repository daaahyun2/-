...
%>
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<a href="#" class="active dropdown-toggle"
					...
					style="font-size: 30px; color: blue;">SUBMIT 
				...
				<li class="active"><a href="notice.jsp" style="color: gray;">NOTICE <span
						class="sr-only">(current)</span></a></li>
				<li><a href="boardlist.jsp" style="color: gray;">Q&A</a></li>
			</ul>
	...
	<div class="container">
	<h1 class="text-center" style="color:red;">NOTICE*</h1><br><br>
		...
		<div class="container" style="text-align: center;">
			...
			&nbsp; 
			[<a href="#" onclick="window.open('admin_index.jsp', '', 'width=300,height=150,top=200,left=300')">관리자용</a>]
			&nbsp;
		</div>
